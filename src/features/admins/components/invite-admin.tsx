...
import { useInviteAdmin } from "../api/use-invite-admins";
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button icon={<PlusCircle className="size-4" />}>Invite Admin</Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[550px]">
        <DialogHeader>
          <DialogTitle>Invite to new admin</DialogTitle>
          <DialogDescription>
        ...
        <Alert>
          ...
          <AlertDescription className="mt-3 text-xs text-foreground/70">
            <p>{`You can only invite admins who have an account on this platform.`}</p>
            <p>
              <Link
