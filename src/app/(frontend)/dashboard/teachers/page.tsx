...
import { TeachersListing } from "@/features/teachers/components/teacher-listing";
import { TeachersTableActions } from "@/features/teachers/components/teachers-table/teachers-table-actions";
      ...
      <div className="px-5 pb-5 flex-1 flex items-center justify-center w-full h-full">
        <Card className="w-full h-full bg-sidebar p-0 flex flex-col items-center justify-center">
          ...
          <h1 className="mt-5 font-heading text-2xl font-semibold">
            Select nursery to manage teachers
          </h1>
    ...
    <PageContainer scrollable={false}>
      <div className="flex flex-1 flex-col space-y-4">
        <AppPageShell
          ...
          description={`Manage teachers in "${activeOrgData.name}"`}
          actionComponent={
